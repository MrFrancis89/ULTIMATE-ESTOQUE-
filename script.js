...
btnLupa.addEventListener('touchend', (e) => {
    e.preventDefault();
    if (pressTimer) { clearTimeout(pressTimer); pressTimer = null; toggleSearch(null); }
});
...
// V4.10: CORREÇÃO DA SOBRESCRITA DO TÍTULO. AGORA ELE MANTÉM O DESIGN.
function atualizarTitulos() { 
    document.getElementById("titulo-pagina").innerHTML = `<span class="titulo-estoque" style="font-weight: 400; letter-spacing: 1px; color: #cccccc;">ESTOQUE</span> <span style="color: var(--btn-danger); font-weight: 900; margin-left: 4px;">V4.10</span>`; 
